package some_preq._06_cses._03_sorting_searching;
...
public class _01_ferris_wheel {
    ...
    public static void solve() throws IOException {
        ...
        while (l<=r) {
            if (nums[l]+nums[r]<=max) {//// If the heaviest and lightest child can fit in
                // a gondola, then pair them up
                ans++;
                l++;
                r--;
            }else{// // If the heaviest and lightest child cannot fit
