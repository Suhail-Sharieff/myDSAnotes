...
public class _3_subSeqWithSumK {
    //func1 and func2 are for subSeq only from array and u cannot repeat arrayElemnts more than their freqency in original array/vector
    ...
    //func3 and func4 would be for same as func1 and func2 but u can repeat unlimited no if times the same elemnt from orignal array in a subsequence which would sum to given target
